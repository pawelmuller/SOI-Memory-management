...
_PROTOTYPE( int do_setscheda, (void)						);
_PROTOTYPE( int do_setschedb, (void)						);
_PROTOTYPE( int do_changeprocgr, (void)						);
_PROTOTYPE( int do_getgrtime, (void)						);
_PROTOTYPE( int do_getprocgr, (void)						);
