...
_PROTOTYPE (int (*call_vec[NCALLS]), (void) ) = {
	...
	do_setscheda,	/* 79 = SETSCHEDA */
	do_setschedb,	/* 80 = SETSCHEDB */
	do_changeprocgr,	/* 81 = CHANGEPROCGR */
	do_getgrtime,	/* 82 = GETGRTIME */
	do_getprocgr,	/* 83 = GETPROCGR */
	do_hole_map,	/* 84 = HOLE_MAP */
	do_worst_fit,	/* 85 = WORST_FIT */
};
